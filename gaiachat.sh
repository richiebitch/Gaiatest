...
general_questions=(
    ...
    "What is something you recently learned that surprised you?"
    "How would you describe your perfect weekend?"
    "What’s a book, movie, or show that left a strong impression on you, and why?"
    "If you could instantly master any skill, which one would it be and why?"
    "What’s a small habit that has improved your life?"
    ...
    "What’s a challenge you recently faced, and how did you handle it?"
    ...
    "What’s a mistake you made that turned into a valuable lesson?"
    ...
    "If you could relive one day from your past, which day would you choose and why?"
    "What’s a goal you’re currently working toward?"
    "What’s something about your daily routine that you really enjoy?"
    "If you could switch lives with a fictional character for a week, who would it be and why?"
    "What’s a common misconception about a topic you know well?"
    "How do you usually prepare for a big decision?"
    "What’s a creative project or idea you’ve been thinking about lately?"
    "What’s a piece of technology you rely on every day and couldn’t live without?"
    "If you had unlimited time and resources, what personal project would you start?"
    "What’s a tradition or ritual that’s important to you?"
    "How do you usually celebrate personal achievements?"
    "What’s a skill you’ve developed over time that you’re proud of?"
